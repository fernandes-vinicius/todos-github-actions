...
export class UseCaseFactory {
  ...
  private static _setTodoHasDoneUseCaseInstance: SetTodoHasDoneUseCase;
  ...
  static get setTodoHasDoneUseCase(): SetTodoHasDoneUseCase {
    if (!this._setTodoHasDoneUseCaseInstance) {
      this._setTodoHasDoneUseCaseInstance = new SetTodoHasDoneUseCase(
        RepositoryFactory.todoRepository
      );
    }
    return this._setTodoHasDoneUseCaseInstance;
  }
